...
class SuggestComponent extends StatelessWidget {
  ...
  const SuggestComponent({super.key, required this.listClock});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              ButtonNotClickMulti(
                  onTap: () {
                    context.push(MainRouterPath.routerClockPage, extra: DataPageModel(pageName: 'Gợi ý', listData: listClock));
                  },
                  child: const Text(
                    "Xem tất cả >",
